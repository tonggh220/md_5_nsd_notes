...
>>> headers = {"User-Agent":"Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20110101 Firefox/52.0"}
...
```python
>>> url6 = 'https://t.cn/weather'
>>> data = {'query': 'linux'}
>>> r = requests.post(url6, data=json.dumps(data))
>>> r.json()
```
