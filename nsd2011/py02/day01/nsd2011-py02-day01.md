...
'/root/nsd2020/nsd2011/py02/day01'
>>> os.mkdir('/tmp/nsd2011')  # mkdir /tmp/nsd2011
>>> os.makedirs('/tmp/demo/nsd2011')  # mkdir -p /tmp/demo/nsd2011
>>> os.listdir()  # ls
...
>>> os.rmdir('/tmp/demo/nsd2011')  # rmdir /tmp/demo/nsd2011  只能删空目录
>>> shutil.rmtree('/tmp/nsd2011')
...
>>> os.path.basename('/tmp/demo/nsd2011/a.txt')  # 返回最右面/右侧内容
'a.txt'
>>> os.path.dirname('/tmp/demo/nsd2011/a.txt')   # 返回最右面/左侧内容
'/tmp/demo/nsd2011'
>>> os.path.split('/tmp/demo/nsd2011/a.txt')  # 返回元组
('/tmp/demo/nsd2011', 'a.txt')
>>> os.path.join('/tmp/demo/nsd2011', 'a.txt')  # 路径拼接
'/tmp/demo/nsd2011/a.txt'
```
