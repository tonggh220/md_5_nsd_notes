...
# 创建数据库
MariaDB [dj2011]> CREATE DATABASE dj2005 DEFAULT CHARSET utf8mb4;
...
MariaDB [dj2011]> show tables;
| polls_choice               |
MariaDB [dj2011]> desc polls_choice;
+-------------+--------------+------+-----+---------+----------------+
| Field       | Type         | Null | Key | Default | Extra          |
+-------------+--------------+------+-----+---------+----------------+
| id          | int(11)      | NO   | PRI | NULL    | auto_increment |
