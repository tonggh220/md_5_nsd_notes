...
MariaDB [(none)]> CREATE DATABASE dj2010 DEFAULT CHARSET utf8mb4;
...
# 解决方法
[root@localhost mysite]# yum install -y mariadb-devel gcc
...
# 创建数据库
MariaDB [dj2010]> CREATE DATABASE dj2005 DEFAULT CHARSET utf8mb4;
...
MariaDB [dj2010]> show tables;
| polls_choice               |
MariaDB [dj2010]> desc polls_choice;
+-------------+--------------+------+-----+---------+----------------+
| Field       | Type         | Null | Key | Default | Extra          |
+-------------+--------------+------+-----+---------+----------------+
| id          | int(11)      | NO   | PRI | NULL    | auto_increment |
