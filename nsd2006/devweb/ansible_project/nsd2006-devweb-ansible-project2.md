# nsd2006-devweb-ansible-project2
...
[root@localhost myansible]# cp nsd2020/nsd2006/devops/day03/adhoc2.py webadmin/adhoc.py
...
# 拷贝django站点到目标位置
[root@localhost ~]# cp -r nsd2020/nsd2006/devweb/ansible_project/myansible/ /opt
