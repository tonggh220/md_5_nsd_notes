...
MariaDB [(none)]> CREATE DATABASE dj2004 DEFAULT CHARSET utf8mb4;
...
```python
[root@localhost ~]# cp -r nsd2020/nsd2003/devweb/day0304/mysite/ /tmp
# 创建数据库
MariaDB [dj2004]> CREATE DATABASE dj2003 DEFAULT CHARSET utf8mb4;
...
MariaDB [dj2004]> show tables;
| polls_choice               |
MariaDB [dj2004]> desc polls_choice;
+-------------+--------------+------+-----+---------+----------------+
| Field       | Type         | Null | Key | Default | Extra          |
+-------------+--------------+------+-----+---------+----------------+
| id          | int(11)      | NO   | PRI | NULL    | auto_increment |
