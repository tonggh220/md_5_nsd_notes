...
'/root/nsd2020/nsd2004/py02/day01'
>>> os.mkdir('/tmp/nsd2004')  # mkdir /tmp/nsd2004
>>> os.makedirs('/tmp/demo/nsd2004')  # mkdir -p /tmp/demo/nsd2004
>>> os.listdir()  # ls
...
>>> os.rmdir('/tmp/demo/nsd2004')  # rmdir /tmp/demo/nsd2004  只能删空目录
>>> shutil.rmtree('/tmp/nsd2004')
...
>>> os.path.basename('/tmp/demo/nsd2004/a.txt')  # 返回最右面/右侧内容
'a.txt'
>>> os.path.dirname('/tmp/demo/nsd2004/a.txt')   # 返回最右面/左侧内容
'/tmp/demo/nsd2004'
>>> os.path.split('/tmp/demo/nsd2004/a.txt')  # 返回元组
('/tmp/demo/nsd2004', 'a.txt')
>>> os.path.join('/tmp/demo/nsd2004', 'a.txt')  # 路径拼接
'/tmp/demo/nsd2004/a.txt'
```
