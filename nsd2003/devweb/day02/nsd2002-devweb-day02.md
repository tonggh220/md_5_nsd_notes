...
```html
<mark>达内云计算 nsd2003</mark>
<del>达内云计算 nsd2003</del>
<s>达内云计算 nsd2003</s>
<ins>达内云计算 nsd2003</ins>
<u>达内云计算 nsd2003</u>
<small>达内云计算 nsd2003</small>
<strong>达内云计算 nsd2003</strong>
<b>达内云计算 nsd2003</b>
<em>达内云计算 nsd2003</em>
<i>达内云计算 nsd2003</i>
```
...
```html
<p class="text-center">达内云计算 nsd2003</p>
<p class="text-left">达内云计算 nsd2003</p>
<p class="text-right">达内云计算 nsd2003</p>
```
...
```html
<p class="text-center text-primary bg-warning">达内云计算 nsd2003</p>
<p class="text-left text-danger bg-success">达内云计算 nsd2003</p>
<p class="text-right text-muted bg-info">达内云计算 nsd2003</p>
```
...
```html
<!-- 圆角矩形 -->
<img class="img-rounded" src="https://img01.sogoucdn.com/app/a/100520031/c0b43a061bdb06f3b983953f41e7e8d0">
<!-- 圆形 -->
<img class="img-circle" src="https://img01.sogoucdn.com/app/a/100520031/c0b43a061bdb06f3b983953f41e7e8d0">
<!-- 支持自动缩放 -->
<img class="img-thumbnail" src="https://img01.sogoucdn.com/app/a/100520031/c0b43a061bdb06f3b983953f41e7e8d0">
```
