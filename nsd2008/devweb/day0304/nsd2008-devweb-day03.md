...
MariaDB [(none)]> CREATE DATABASE dj2008 DEFAULT CHARSET utf8mb4;
...
# 创建数据库
MariaDB [dj2008]> CREATE DATABASE dj2005 DEFAULT CHARSET utf8mb4;
...
MariaDB [dj2008]> show tables;
| polls_choice               |
MariaDB [dj2008]> desc polls_choice;
+-------------+--------------+------+-----+---------+----------------+
| Field       | Type         | Null | Key | Default | Extra          |
+-------------+--------------+------+-----+---------+----------------+
| id          | int(11)      | NO   | PRI | NULL    | auto_increment |
