...
MariaDB [(none)]> CREATE DATABASE dj2005 DEFAULT CHARSET utf8mb4;
...
# 创建数据库
MariaDB [dj2005]> CREATE DATABASE dj2003 DEFAULT CHARSET utf8mb4;
...
MariaDB [dj2005]> show tables;
| polls_choice               |
MariaDB [dj2005]> desc polls_choice;
+-------------+--------------+------+-----+---------+----------------+
| Field       | Type         | Null | Key | Default | Extra          |
+-------------+--------------+------+-----+---------+----------------+
| id          | int(11)      | NO   | PRI | NULL    | auto_increment |
